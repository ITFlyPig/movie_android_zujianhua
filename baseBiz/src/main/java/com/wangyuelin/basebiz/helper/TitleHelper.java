...
public class TitleHelper {
     ...
     * @param activity
     */
    public void setContentView(int resLayout, FragmentActivity activity) {
        if (activity == null) {
            return;
        }
    ...
    public void setContentView(View v, FragmentActivity activity) {
     ...
     * @return
     */
    public View onCreateView(View content, Fragment fragment){
        View v = LayoutInflater.from(fragment.getContext()).inflate(R.layout.base_activity, null);
        ViewGroup rlTitle = v.findViewById(R.id.title);
        FrameLayout flContent = v.findViewById(R.id.content);
        //设置标题
